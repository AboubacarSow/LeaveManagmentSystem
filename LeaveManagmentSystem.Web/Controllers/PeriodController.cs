...
public class PeriodController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Name,StartOn,EndOn,Id")] Period period)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int id, [Bind("Name,StartOn,EndOn,Id")] Period period)
    {
        if (id != period.Id)
        {
            return NotFound();
